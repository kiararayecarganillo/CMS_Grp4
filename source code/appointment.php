...
<?php
    ...
    else
    {
       ...
       $sql ="INSERT INTO appointment(patientid, temperature, appointmentdate, appointmenttime, doctorid, status, app_reason, medicine, treatment, remarks) values('$_POST[patient]','$_POST[temperature]','$_POST[appointmentdate]','$_POST[appointmenttime]','$_POST[doctor]','$_POST[status]','$_POST[reason]','$chk','$_POST[treatment]','$_POST[remarks]')";
        if($qsql = mysqli_query($conn,$sql))
        {
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <?php
        ...
        while($rsdoctor=mysqli_fetch_array($qsqldoctor))
        {
            ...
            {
             echo "<option value='$rsdoctor[doctorname]' selected>$rsdoctor[doctorid] - $rsdoctor[doctorname]</option>";
            }
            else
            {
                echo "<option value='$rsdoctor[doctorname]'>$rsdoctor[doctorid] - $rsdoctor[doctorname]</option>";
            }
  ...
  <div class="dropdown-menu" style="width:600px;" aria-labelledby="dropdownMenuButton">
    ...
    <div class="input-group mr-3" style="margin:0;">
            ...
            <label class = "pl-2 py-1 border w-100 h-100 ml-2" for = "Mefenamic">Mefenamic Acid</label>
            </div>
            <div class="input-group" style="margin:0;">
            <div class="input-group-prepend">
                <div class="input-group-text" style="padding:5px;padding-bottom:2px;background:#DDDDDD;border-radius:5px;">
