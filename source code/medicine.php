...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="UPDATE medicine SET medicinename='$_POST[medicinename]',medicinecost='$_POST[medicinecost]',description='$_POST[description]',expiry='$_POST[expiry],status='$_POST[status]' WHERE medicineid='$_GET[editid]'";
 ...
 <?php
    ...
    {
        $sql ="INSERT INTO medicine(medicinename,medicinecost,description,expiry,status) values('$_POST[medicinename]','$_POST[medicinecost]','$_POST[description]','$_POST[expiry]','$_POST[status]')";
        if($qsql = mysqli_query($conn,$sql))
        {
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input class="form-control" name="description" id="description"><?php if(isset($_GET['editid'])) { echo $rsedit['description']; } ?></input>
            <span class="messages"></span>
        </div>
    </div>

    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Medicine Expiration Date</label>
        <div class="col-sm-8">
            <input class="form-control" name="expiry" id="expiry"><?php if(isset($_GET['editid'])) { echo $rsedit['expiry']; } ?></input>
            <span class="messages"></span>
        </div>
    </div>
