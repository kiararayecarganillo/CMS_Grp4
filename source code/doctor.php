...
<li class="breadcrumb-item"><a>Nurse</a>
</li>
<li class="breadcrumb-item"><a href="add_user.php">Nurse</a>
</li>
</ul>
</div>
</div>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Nurse Name</label>
        <div class="col-sm-4">
...
<?php } ?> 
    ...
    <div class="form-group row">
    <label class="col-sm-2 col-form-label">Work Duty</label>
        <div class="col-sm-4">
