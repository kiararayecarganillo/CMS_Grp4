...
<meta name="author" content="ESMERALDA PICANA +9236416299.">
...
<div class="wrapper" style="background: #023047; max-width: 550px; width: 100%; padding: 40px; border-radius: 20px;">
    <div class="card" style="background: #fff;padding: 20px; width: 100%; margin: 0 auto;">
...
<h5 class="text-center txt-primary">Sign In</h5>
  ...
  <form method="POST" >
    ...
    <div class="row m-t-30">
      <div class="col-md-12">
        <button type="submit" name="btn_login" class="btn text-white btn-md btn-block waves-effect text-center m-b-20" style="background: #00AC17">LOGIN</button>
      </div>
    </div>
  </form>
